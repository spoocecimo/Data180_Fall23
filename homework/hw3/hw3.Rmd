...
**Due date:** October 5 beginning of class.
...
```{r}
ggplot(Cars93, aes(x=EngineSize,y=MPG.city))+geom_point(col='blue', size=2) +  labs(y='MPG City',x='Engine Size', title='MPG City vs Engine Size', subtitle='MPG City and Engine Size', caption='Taken from cars93')+xlim(0.5,6)+ylim(10,47)
```
```
...
```{r}
ggplot(Cars93, aes(x=EngineSize,y=MPG.city, color=Type))+geom_point(size=2) +  labs(y='MPG City',x='Engine Size', title='MPG City vs Engine Size', subtitle='MPG City and Engine Size', caption='Taken from cars93')+xlim(0.5,6)+ylim(10,47)
```
...
```{r}
ggplot(Cars93, aes(x=EngineSize,y=MPG.city, color=Type))+geom_point(size=2) +  labs(y='MPG City',x='Engine Size', title='MPG City vs Engine Size', subtitle='MPG City and Engine Size', caption='Taken from cars93')+xlim(0.5,6)+ylim(10,47)+geom_smooth(color='red',linetype='dashed')
```
...
```{r}
ggplot(data=Cars93,aes(x=AirBags,fill=AirBags))+geom_bar()+labs(y='count',x='Airbag Status',Title='Barplot',subtitle='Cars93',caption='Airbags data')
```
...
```{r}
ggplot(data=Cars93,aes(x=AirBags,fill=AirBags))+geom_bar(position='dodge')+labs(y='count',x='Airbag Status',Title='Barplot',subtitle='Cars93',caption='Airbags data')+facet_wrap(~Origin)
```
...
```{r}
ggplot(sf_oz) + geom_sf()+coord_sf(crs=st_crs(3112))
```
